...
import com.application.villageFoods.payload.requests.LoginRequest;
import com.application.villageFoods.payload.requests.SignupRequest;
import com.application.villageFoods.payload.responses.MessageResponse;
import com.application.villageFoods.payload.responses.UserInfoResponse;
import com.application.villageFoods.repository.RoleRepository;
import com.application.villageFoods.repository.UserRepository;
import com.application.villageFoods.security.jwt.JwtUtils;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    ...
                    case "mod":
                        ...
                        break;
                    case "warehouseAdmin":
                        Role warehouseAdminRole = roleRepository.findByName(ERole.ROLE_WAREHOUSE_ADMIN)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(warehouseAdminRole);
